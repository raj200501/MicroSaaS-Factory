...
export default function MicroappStub() {
  return (
    <div className="grid gap-8 md:grid-cols-2 lg:max-w-6xl mx-auto w-full p-4 md:p-8">
      <Card>
        <CardHeader>
          <CardTitle>Podcast Intro</CardTitle>
          <CardDescription>Write a script for a podcast intro.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={async (formData) => {
            "use server";
            // Local stub logic: Deterministic DummyProvider output
            console.log("Generating podcast-intro output...");
          }} className="space-y-4">

            <div className="space-y-2">
              <Label htmlFor="show">Show Name/Host</Label>
              <Input id="show" name="show" required />
            </div>
      ...
      <Card className="bg-muted/50">
        <CardHeader>
          ...
          <CardDescription>Expect: A catchy 60-second intro script</CardDescription>
        </CardHeader>
