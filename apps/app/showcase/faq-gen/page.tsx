    ...
    <div className="grid gap-8 md:grid-cols-2 lg:max-w-6xl mx-auto w-full p-4 md:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Generate FAQs for a webpage.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={async (formData) => {
            "use server";
            // Local stub logic: Deterministic DummyProvider output
            console.log("Generating faq-gen output...");
          }} className="space-y-4">

            <div className="space-y-2">
              <Label htmlFor="service">Service Details</Label>
              <Textarea id="service" name="service" required />
            </div>
      ...
      <Card className="bg-muted/50">
        <CardHeader>
          ...
          <CardDescription>Expect: 5 common FAQs and answers</CardDescription>
        </CardHeader>
