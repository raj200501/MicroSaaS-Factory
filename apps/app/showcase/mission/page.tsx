    ...
    <div className="grid gap-8 md:grid-cols-2 lg:max-w-6xl mx-auto w-full p-4 md:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Draft a corporate mission statement.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={async (formData) => {
            "use server";
            // Local stub logic: Deterministic DummyProvider output
            console.log("Generating mission output...");
          }} className="space-y-4">

            <div className="space-y-2">
              <Label htmlFor="coreValues">Core Values</Label>
              <Input id="coreValues" name="coreValues" required />
            </div>
      ...
      <Card className="bg-muted/50">
        <CardHeader>
          ...
          <CardDescription>Expect: A powerful mission statement</CardDescription>
        </CardHeader>
