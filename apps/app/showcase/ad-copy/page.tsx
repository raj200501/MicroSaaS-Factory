    ...
    <div className="grid gap-8 md:grid-cols-2 lg:max-w-6xl mx-auto w-full p-4 md:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Generate Facebook Ad copy.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={async (formData) => {
            "use server";
            // Local stub logic: Deterministic DummyProvider output
            console.log("Generating ad-copy output...");
          }} className="space-y-4">

            <div className="space-y-2">
              <Label htmlFor="offer">The Offer</Label>
              <Input id="offer" name="offer" required />
            </div>
      ...
      <Card className="bg-muted/50">
        <CardHeader>
          ...
          <CardDescription>Expect: 3 variations of ad copy</CardDescription>
        </CardHeader>
