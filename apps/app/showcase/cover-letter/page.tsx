    ...
    <div className="grid gap-8 md:grid-cols-2 lg:max-w-6xl mx-auto w-full p-4 md:p-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Generate a cover letter for a job application.</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={async (formData) => {
            "use server";
            // Local stub logic: Deterministic DummyProvider output
            console.log("Generating cover-letter output...");
          }} className="space-y-4">
      ...
      <Card className="bg-muted/50">
        <CardHeader>
          ...
          <CardDescription>Expect: A professional cover letter</CardDescription>
        </CardHeader>
